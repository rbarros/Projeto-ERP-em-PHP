...
class ProdutoReport extends TPage
{
    ...
    public function __construct()
    {
        ...
        $id = new TDBCombo('id', 'base_banco', 'Produto', 'id', '{descricao}','descricao asc'  );
        $cliente_id = new TDBUniqueSearch('cliente_id', 'base_banco', 'Produto', 'id', 'descricao','descricao asc' , $criteria_cliente_id );
        ...
        $row2 = $this->form->addFields([new TLabel("Nome Produto:", null, '14px', null)],[$cliente_id],[new TLabel("Vendedor:", null, '14px', null)],[$vendedor_id]);
