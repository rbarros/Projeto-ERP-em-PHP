...
class CidadeForm extends TWindow
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        parent::setTitle("Cadastro de cidade");
        ...
        $row2 = $this->form->addFields([new TLabel("Cidade:", '#000000', '14px', null)],[$nome]);
        $row3 = $this->form->addFields([new TLabel("Estado", '#000000', '14px', null)],[$estado_id]);
