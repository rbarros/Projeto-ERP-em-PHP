...
class FornecedorList extends TPage
{
    ...
    private static $formName = 'formList_Fornecedor';
    ...
    public function __construct($param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Razao social:", null, '14px', null, '100%'),$razao_social],[new TLabel("Dt ativacao:", null, '14px', null),$dt_ativacao,new TLabel("Id:", null, '14px', null),$id]);
        $row1->layout = ['col-sm-6','col-sm-6'];

        $row2 = $this->form->addFields([new TLabel("Cnpj:", null, '14px', null, '100%'),$cnpj],[new TLabel("Nome fantasia:", null, '14px', null),$nome_fantasia]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['FornecedorForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_fk_cidade_nome = new TDataGridColumn('fk_cidade->nome', "Cidade", 'left');
        ...
        $this->datagrid->addColumn($column_fk_cidade_nome);
        ...
        $action_onDelete = new TDataGridAction(array('FornecedorList', 'onDelete'));
