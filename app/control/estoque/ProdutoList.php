...
class ProdutoList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $btn_onedit = $this->form->addAction("Cadastrar", new TAction(['ProdutoNForm', 'onEdit']), 'fas:plus #69aa46');
    ...
    public function onDelete($param = null) 
    {
             ...
             if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                $transferencias = TransferenciaEtq::where('id_produto','=',$object->id)->load();
                ...
                $estoques = ProdEstoque::where('id_produto','=',$object->id)->load();
    ...
    public function onImport($param = null) 
    {
        try 
        {
            ...
            $pageParam = ['tipoImport'=> 'Produto']; // ex.: = ['key' => 10]

            TApplication::loadPage('ProdutoExport', 'onShow', $pageParam);
