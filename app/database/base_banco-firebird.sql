...
CREATE TABLE documento( 
      ...
      dt_registro date    NOT NULL , 
      colaborador_id integer    NOT NULL , 
      tipo_documento integer    DEFAULT 1  NOT NULL , 
...
CREATE TABLE venda_item_alt( 
 ...
 CREATE UNIQUE INDEX unique_idx_loja_abreviacao ON loja COMPUTED BY (abreviacao);
 CREATE UNIQUE INDEX unique_idx_loja_nome_fantasia ON loja COMPUTED BY (nome_fantasia);
 CREATE UNIQUE INDEX unique_idx_loja_cnpj ON loja COMPUTED BY (cnpj);
 CREATE UNIQUE INDEX unique_idx_loja_inscr_estadual ON loja COMPUTED BY (inscr_estadual);
 CREATE UNIQUE INDEX unique_idx_pessoa_email ON pessoa COMPUTED BY (email);
 CREATE UNIQUE INDEX unique_idx_produto_SKU ON produto COMPUTED BY (SKU);
 CREATE UNIQUE INDEX unique_idx_venda_alt_id_interno ON venda_alt COMPUTED BY (id_interno);
...
ALTER TABLE compra_funcionario ADD CONSTRAINT compra_funcionario_61dc287c58910 FOREIGN KEY (colaborador_id) references colaborador(id); 
...
ALTER TABLE parcelas_conta ADD CONSTRAINT parcelas_conta_61dc287c5ade2 FOREIGN KEY (conta_bancaria_fornecedor) references conta_bancaria(id); 
...
ALTER TABLE subparcelas_parcela ADD CONSTRAINT subparcelas_parcela_61dc287c5bcee FOREIGN KEY (fornecedor_id) references fornecedor(id); 
ALTER TABLE subparcelas_parcela ADD CONSTRAINT subparcelas_parcela_61dc287c5bd01 FOREIGN KEY (conta_bancaria_loja) references conta_bancaria(id); 
...
ALTER TABLE subparcelas_parcela ADD CONSTRAINT subparcelas_parcela_61dc287c5bd25 FOREIGN KEY (conta_bancaria_fornecedor) references conta_bancaria(id); 
...
ALTER TABLE transferencia_colaborador ADD CONSTRAINT transferencia_colaborador_61dc287c5c4a9 FOREIGN KEY (motivo_transferencia) references motivo_transferencia_colaborador(id); 
ALTER TABLE transferencia_colaborador ADD CONSTRAINT transferencia_colaborador_61dc287c5c4bc FOREIGN KEY (loja_origem) references loja(id); 
ALTER TABLE transferencia_colaborador ADD CONSTRAINT transferencia_colaborador_61dc287c5c4ce FOREIGN KEY (loja_destino) references loja(id); 
