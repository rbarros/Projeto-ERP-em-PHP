...
class MestreVariavel extends TRecord
{
    const TABLENAME  = 'mestre_variavel';
    const PRIMARYKEY = 'id';
    ...
    public function getProdutos()
    {
        ...
        $criteria->add(new TFilter('mestre_variavel', '=', $this->id));
    ...
    public function get_produto_unidade_to_string()
    {
        ...
        $values = Produto::where('mestre_variavel', '=', $this->id)->getIndexedArray('unidade_id','{unidade->nome}');
    ...
    public function get_produto_categoria_produto_to_string()
    {
        ...
        $values = Produto::where('mestre_variavel', '=', $this->id)->getIndexedArray('categoria_produto_id','{categoria_produto->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fornecedor_to_string()
    {
        ...
        $values = Produto::where('mestre_variavel', '=', $this->id)->getIndexedArray('fornecedor_id','{fornecedor->razao_social}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_marca_to_string()
    {
        ...
        $values = Produto::where('mestre_variavel', '=', $this->id)->getIndexedArray('marca','{fk_marca->marca}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_situacao_prod_to_string()
    {
        ...
        $values = Produto::where('mestre_variavel', '=', $this->id)->getIndexedArray('situacao_prod','{fk_situacao_prod->situacao_prod}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_tipo_cadastro_to_string()
    {
        ...
        $values = Produto::where('mestre_variavel', '=', $this->id)->getIndexedArray('tipo_cadastro','{fk_tipo_cadastro->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_mestre_variavel_to_string()
    {
        ...
        $values = Produto::where('mestre_variavel', '=', $this->id)->getIndexedArray('mestre_variavel','{fk_mestre_variavel->id}');
        return implode(', ', $values);
    }
