...
class EstadoNegociacao extends TRecord
{
    const TABLENAME  = 'estado_negociacao';
    const PRIMARYKEY = 'id';
    ...
    public function getNegociacaos()
    {
        ...
        $criteria->add(new TFilter('estado_negociacao_id', '=', $this->id));
    ...
    public function get_negociacao_cliente_to_string()
    {
        ...
        $values = Negociacao::where('estado_negociacao_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->nome}');
    ...
    public function get_negociacao_vendedor_to_string()
    {
        ...
        $values = Negociacao::where('estado_negociacao_id', '=', $this->id)->getIndexedArray('vendedor_id','{vendedor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_negociacao_origem_negociacao_to_string()
    {
        ...
        $values = Negociacao::where('estado_negociacao_id', '=', $this->id)->getIndexedArray('origem_negociacao_id','{origem_negociacao->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_negociacao_tipo_negociacao_to_string()
    {
        ...
        $values = Negociacao::where('estado_negociacao_id', '=', $this->id)->getIndexedArray('tipo_negociacao_id','{tipo_negociacao->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_negociacao_estado_negociacao_to_string()
    {
        ...
        $values = Negociacao::where('estado_negociacao_id', '=', $this->id)->getIndexedArray('estado_negociacao_id','{estado_negociacao->nome}');
        return implode(', ', $values);
    }
