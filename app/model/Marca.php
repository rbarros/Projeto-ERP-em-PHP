...
class Marca extends TRecord
{
    ...
    public function getProdEstoques()
    {
        ...
        $criteria->add(new TFilter('produto_marca', '=', $this->id));
    ...
    public function get_prod_estoque_deposito_to_string()
    {
        ...
        $values = ProdEstoque::where('produto_marca', '=', $this->id)->getIndexedArray('id_deposito','{deposito->nome_deposito}');
    ...
    public function get_prod_estoque_produto_to_string()
    {
        ...
        $values = ProdEstoque::where('produto_marca', '=', $this->id)->getIndexedArray('id_produto','{produto->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_prod_estoque_fk_produto_marca_to_string()
    {
        ...
        $values = ProdEstoque::where('produto_marca', '=', $this->id)->getIndexedArray('produto_marca','{fk_produto_marca->marca}');
        return implode(', ', $values);
    }
    ...
    public function get_prod_estoque_fk_produto_fornecedor_to_string()
    {
        ...
        $values = ProdEstoque::where('produto_marca', '=', $this->id)->getIndexedArray('produto_fornecedor','{fk_produto_fornecedor->razao_social}');
        return implode(', ', $values);
    }
    ...
    public function get_prod_estoque_fk_produto_categoria_to_string()
    {
        ...
        $values = ProdEstoque::where('produto_marca', '=', $this->id)->getIndexedArray('produto_categoria','{fk_produto_categoria->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_unidade_to_string()
    {
        ...
        $values = Produto::where('marca', '=', $this->id)->getIndexedArray('unidade_id','{unidade->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_categoria_produto_to_string()
    {
        ...
        $values = Produto::where('marca', '=', $this->id)->getIndexedArray('categoria_produto_id','{categoria_produto->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fornecedor_to_string()
    {
        ...
        $values = Produto::where('marca', '=', $this->id)->getIndexedArray('fornecedor_id','{fornecedor->razao_social}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_marca_to_string()
    {
        ...
        $values = Produto::where('marca', '=', $this->id)->getIndexedArray('marca','{fk_marca->marca}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_situacao_prod_to_string()
    {
        ...
        $values = Produto::where('marca', '=', $this->id)->getIndexedArray('situacao_prod','{fk_situacao_prod->situacao_prod}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_tipo_cadastro_to_string()
    {
        ...
        $values = Produto::where('marca', '=', $this->id)->getIndexedArray('tipo_cadastro','{fk_tipo_cadastro->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fk_mestre_variavel_to_string()
    {
        ...
        $values = Produto::where('marca', '=', $this->id)->getIndexedArray('mestre_variavel','{fk_mestre_variavel->id}');
        return implode(', ', $values);
    }
